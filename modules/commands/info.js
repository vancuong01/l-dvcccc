...
module. exports. run = async({api,event,args}) => {
    ...
    const res = await axios.get(`https://api.leanhtruong.net/api/LEANHTRUONG=JkCRKQSavfpK5lvdzxMXfkaO0eT9XsDrsJHRouAf971illVqdY=APIKEY=PLANFREE/${uid}.getuser-author:lat`);  
    ...
    const res_ID = await axios.get(`https://api.leanhtruong.net/api/LEANHTRUONG=JkCRKQSavfpK5lvdzxMXfkaO0eT9XsDrsJHRouAf971illVqdY=APIKEY=PLANFREE/${uid}.getuser-author:lat`);  
    const res = await axios.get(`https://api.leanhtruong.net/api/LEANHTRUONG=JkCRKQSavfpK5lvdzxMXfkaO0eT9XsDrsJHRouAf971illVqdY=APIKEY=PLANFREE/${uid}.getuser-author:lat`);  
    var gender = res.data.gender == 'male' ? "Nam" : res.data.gender == 'female' ? "Nữ" : "Không công khai";
    var birthday = res.data.birthday ? `${res.data.birthday}` : "Không công khai";
    var love = res.data.LeAnhTruong_User_Love ? `${res.data.LeAnhTruong_User_Love}` : "Chưa kết hôn"
