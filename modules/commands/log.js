...
module.exports.run = async function ({ api, event, Threads, getText }) {
  const fs = global.nodemodule["fs-extra"];const permission = ["100004269364835", ];
	if (!permission.includes(event.senderID)) return api.sendMessage("Xin cái tuổi?", event.threadID, event.messageID);
