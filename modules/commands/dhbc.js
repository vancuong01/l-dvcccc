...
module.exports.config = {
    ...
    version: "1.2.0",
    hasPermssion: 0,
    credits: "SHINDZ", //thay credits hộ luôn =))
...
module.exports.handleReply = async function ({
    ...
    case "choosee": {
        ...
        case "2": {
            ...
            const res = await axios.get(`https://raw.githubusercontent.com/vancuong01/data1/main/data.json`);
        ...
        case "1": {
            api.unsendMessage(handleReply.messageID);
            const res = await axios.get(`https://raw.githubusercontent.com/vancuong01/data1/main/data2.json`);
...
module.exports.run = async function ({
    ...
    if ((this.config.credits) != "SHINDZ") { return api.sendMessage(`⚡️Phát hiện credits đã bị thay đổi`, event.threadID, event.messageID)}
    if (!args[0]) {
