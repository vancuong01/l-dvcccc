module.exports.config = {
    ...
    version: "1.0.0",
    hasPermssion: 0,
    credits: "D-Junkie moad lại VCường",
    ...
    envConfig: {
        "YOUTUBE_API": "AIzaSyCUCY2nwSIcY2SfPWAgTVwgzFHxvoWkHdg"
    }
};
...
module.exports.handleReply = async function ({
    ...
    const res = await axios.get(`https://raw.githubusercontent.com/vancuong01/data/main/sing.json`);
...
module.exports.run = async function ({
    ...
    const fs = global.nodemodule["fs-extra"];
    const request = global.nodemodule["request"];
    const res = await axios.get(`https://raw.githubusercontent.com/quyenkaneki/data/main/sing.json`);
    const length_KEY = res.data.keySing.length
    const randomAPIKEY = res.data.keySing[Math.floor(Math.random() * length_KEY)]
