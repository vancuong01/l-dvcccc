...
module.exports.config = {
  ...
  version: "2.0.0",
  hasPermssion: 0,
  credits: "SHINDZ",//Đừng đổi credit Chỉnh ảnh ên đi :(
...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if(event.type == "message_reply") { uid = event.messageReply.senderID }
    ...
    const res = await axios.get(`http://api.leanhtruong.net/key/check-info-key.php?apikey=LEANHTRUONG=YCrQCWfdarHQiB0OJuMOKIZbDupnoDAB8HBgQsHWxlXUhQq8VQ=APIKEY=PLANFREE`); 
